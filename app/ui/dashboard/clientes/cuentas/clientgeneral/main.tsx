...
export default function Main({ data }: { data: Cliente2Dto }) {
  return (
    <div className="flex flex-col xl:flex-row space-y-4 xl:space-y-0 xl:space-x-5 pb-6 pt-2 px-2">
      ...
      <Card className=" bg-background  lg:w-full xl:w-3/4" >
        <CardHeader className="pb-2 md:m-2">
