...
import {
  SIDENAV_ITEMS,
  SIDENAV_ITEMS_TECNICO,
  SIDENAV_ITEMS_CLIENTE,
} from "../constants";
    ...
    <>
      {item.submenu ? (
        ...
        <button
          ...
          className="flex flex-row items-center space-x-4 w-full rounded-lg hover:bg-zinc-200  text-[#637381]  p-2 hover:dark:bg-menu-active dark:text-nav_item"
        >
          {item.icon}
          <span className="flex text-sm font-semibold ">{item.title}</span>
        </button>
